...
output_file_robot_hand = os.path.join(output_dir, "robot_hand.npy")
...
# Iterate over each subdirectory in the input folder to find robot_hand.npy files
for subdir in sorted(os.listdir(input_folder)):
    subdir_path = os.path.join(input_folder, subdir)
    if os.path.isdir(subdir_path):
        # Path to the robot_hand.npy file in the subdirectory
        npy_file_path = os.path.join(subdir_path, "actions.npy")
